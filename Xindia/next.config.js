...
const nextConfig = {
  images: {
    remotePatterns: [
      ...
      { protocol: 'https', hostname: 'xindia-media-worker.xindia369.workers.dev' },
      { protocol: 'https', hostname: 'api.xindia.live' },
    ],
  },
  async headers() {
    return [
        ...
        headers: [
          ...
          { key: 'X-DNS-Prefetch-Control', value: 'on' },
          {
            ...
            value: [
              ...
              "media-src 'self' https://res.cloudinary.com https://*.workers.dev https://xindia-media-worker.xindia369.workers.dev",
